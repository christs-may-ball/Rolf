...
SECRET_KEY = '983-m^c1b$bfjhwyqmzr8cvr$tbzb7t61&jdi^9xj#6me+-&_!'
...
MIDDLEWARE_CLASSES = [
    'rolf.middleware.domain_redirect_middleware.DomainRedirectMiddleware',
...
WSGI_APPLICATION = 'rolf.wsgi.application'
...
UCAMWEBAUTH_RETURN_URL = 'http://christs.herokuapp.com/raven_return/'
